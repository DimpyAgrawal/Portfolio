...
function About() {
  return (
    <div id='about' className='bg-custom-navbar-bg flex flex-col text-custom-font-color'>
      ...
      <div className='flex justify-between w-[70%] mt-[2%] ml-[17%] shadow-custom-shadow shadow-md'>
        
        <div className='shadow-custom-shadow shadow-xl'>
          <h1 className='text-custom-white font-sans font-semibold text-xl'>2021</h1>
          <p className='mt-2 text-gray-400'>Started my journey</p>
        </div>

        <div>
          <h1 className='text-custom-white font-sans font-semibold text-xl'>2022</h1>
          <p className='mt-2 text-gray-400'>Leveraged skills in<br/> DSA </p>
        </div>

        <div>
          <h1 className='text-custom-white font-sans font-semibold text-xl'>2023</h1>
          <p className='mt-2 text-gray-400'>Acquired web development skills<br/> </p>
        </div>

        <div>
          <h1 className='text-custom-white font-sans font-semibold text-xl'>2024</h1>
          <p className='mt-2 text-gray-400'>Developing Projects</p>
        </div>
      </div>
      ...
      <div className='flex ml-[17%] w-[70%] justify-between mt-[2%] '>
        <div className=' shadow-lg bg-slate-900 shadow-gray-950 w-[20%] p-4 rounded-xl pr-10'>
          <h1 className='font-sans font-bold text-2xl text-custom-welcom'>400+</h1>
          <p className='mt-1 text-gray-400'>LeetCode Questions</p>
        </div>

        <div className=' shadow-lg bg-slate-900 w-[20%] shadow-gray-950 p-4 rounded-xl pr-10'>
        ...
        <div className=' shadow-lg bg-slate-900 w-[20%] shadow-gray-950 p-4 rounded-xl pr-10'>
          ...
          <p className='mt-1 text-gray-400'>Tech Hackthons</p>
        </div>
