  ...
  return (
    <div id='home' className='bg-custom-navbar-bg flex flex-col'>
      <div className='text-custom-welcom  font-sans w-[40%] ml-[17%] sm:mt-[4%] mt-[25%]'>
        ...
        <button type="button" class="bg-gradient-to-r font-semibold pl-10 pr-10 pt-2 pb-2 mt-6 rounded-full from-green-400 to-blue-500 "><a href="https://drive.google.com/file/d/1_AGw6n24Tt7Be9xwQJTK1f66C1v9JipQ/view?usp=sharing d">Get CV</a></button>
