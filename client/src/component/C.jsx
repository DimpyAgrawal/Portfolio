...
function C() {
  return (
   ...
   <div id='projects' className='example bg-custom-navbar-bg  flex flex-col w-screen'>
      <h1 className='text-4xl ml-[17%] font-sans mt-[8%] text-custom-white font-semibold'>Projects</h1>

      <div class='flex flex-wrap md:ml-[20%] justify-between mt-[5%] h-[76vh] overflow-auto w-[50vw] m-auto'>
